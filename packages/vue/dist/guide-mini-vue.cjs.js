...
})(exports.EShapeFlags || (exports.EShapeFlags = {}));
...
function createVNode(type, props, children) {
    ...
    if (typeof children === 'string') {
        vnode.shapeFlag |= exports.EShapeFlags.TEXT_CHILDREN;
    }
    else if (Array.isArray(children)) {
        vnode.shapeFlag |= exports.EShapeFlags.ARRAY_CHILDREN;
    }
    if (vnode.shapeFlag & exports.EShapeFlags.STATEFUL_COMPONENT) {
        if (typeof children === 'object') {
            vnode.shapeFlag |= exports.EShapeFlags.SLOT_CHILDREN;
        }
    }
    return vnode;
}
...
function getShapeFlag(type) {
    return typeof type === 'string' ? exports.EShapeFlags.ELEMENT : exports.EShapeFlags.STATEFUL_COMPONENT;
}
...
function createRenderer(options) {
    ...
    function patch(n1, n2, container, parent, anchor) {
        ...
        switch (type) {
            ...
            case Text:
                ...
                break;
            default:
                if (n2.shapeFlag & exports.EShapeFlags.ELEMENT) {
                    processElement(n1, n2, container, parent, anchor);
                }
                else if (n2.shapeFlag & exports.EShapeFlags.STATEFUL_COMPONENT) {
    ...
    function patchChildren(n1, n2, container, parent, anchor) {
        ...
        if (shapeFlag & exports.EShapeFlags.TEXT_CHILDREN) {
            if (prevShapflag & exports.EShapeFlags.ARRAY_CHILDREN) {
                unmountChildren(c1);
                hostSetElementText(container, c2);
            }
            else if (prevShapflag & exports.EShapeFlags.TEXT_CHILDREN) {
                hostSetElementText(container, c2);
            }
        }
            ...
            else if (prevShapflag & exports.EShapeFlags.ARRAY_CHILDREN) {
    ...
    function mountElement(vnode, container, parent, anchor) {
        ...
        if (vnode.shapeFlag & exports.EShapeFlags.TEXT_CHILDREN) {
            el.innerText = children;
        }
        else if (vnode.shapeFlag & exports.EShapeFlags.ARRAY_CHILDREN) {
...
var runtimeDom = /*#__PURE__*/Object.freeze({
    ...
    proxyRefs: proxyRefs,
    effect: effect,
    get EShapeFlags () { return exports.EShapeFlags; },
    extend: extend,
    isObject: isObject,
    isString: isString,
...
exports.toHandleKey = toHandleKey;
exports.unRef = unRef;
